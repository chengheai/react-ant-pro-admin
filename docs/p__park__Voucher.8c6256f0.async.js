  ...
  [537],
  {
    83478: function (de, U, n) {
                ...
                for (;;)
                  switch ((a.prev = a.next)) {
                    case 0:
                      return a.abrupt(
                        'return',
                        (0, E.WY)('/api/rule', (0, p.Z)({ data: r, method: 'PUT' }, l || {})),
                      );
                    case 1:
                    case 'end':
                      return a.stop();
                ...
                for (;;)
                  switch ((a.prev = a.next)) {
                    case 0:
                      return a.abrupt(
                        'return',
                        (0, E.WY)('/api/rule', (0, p.Z)({ data: r, method: 'POST' }, l || {})),
                      );
                    case 1:
                    case 'end':
                      return a.stop();
                ...
                for (;;)
                  switch ((a.prev = a.next)) {
                    case 0:
                      return a.abrupt(
                        'return',
                        (0, E.WY)('/api/rule', (0, p.Z)({ data: r, method: 'DELETE' }, l || {})),
                      );
                    case 1:
                    case 'end':
                      return a.stop();
      ...
      var Y = n(37476),
        ...
        ae = ne,
        te = function () {
          var r = (0, Z.useState)(!1),
            l = (0, V.Z)(r, 2),
            o = l[0],
            a = l[1],
            c = (0, Z.useState)(void 0),
            x = (0, V.Z)(c, 2),
            g = x[0],
            f = x[1],
            S = (0, Z.useState)(!1),
            ...
            se = function (d) {
              q((0, p.Z)({}, d)),
                F.default.success('\u6DFB\u52A0\u6210\u529F'),
                a(!1),
                b.current && b.current.reload();
            },
            ie = function (d) {
              X((0, p.Z)({}, d)),
                F.default.success('\u4FEE\u6539\u6210\u529F'),
                O(!1),
                b.current && b.current.reload();
            },
            G = (function () {
